        ...
        <>
            ...
            >
                <Group w="100%" style={{borderRadius:"50px", height:"40px"}} ff={"Oswald"}>
                    <Text ta="center" c="#8E8D8A" pl="10px" size="lg" w="20%">Aktualny Cel</Text>
                    <Group c="white" bg="#E98074" miw="40%" maw="60%" style={{borderRadius:"200px"}} ff={"Oswald"} justify="center">
                        <Text ta="center" pl="10px" size="lg" w="60%">{activeObjective[0].title}</Text>
